...
//		printMatrixComplexBinFile("decVTA.dat",outVTA->format,outVTA->raw,outVTA->nrows,outVTA->ncols);
	...
	integer dimRange = atoi(argv[3]);
	integer niter = atoi(argv[4]);
...
//		tamaClss::genMatrix<__lpkdoublecomplex> * RRdecS = new tamaClss::genMatrix<__lpkdoublecomplex>;
		...
		__lpkdoublereal tolerance = 1e-3;
...
//
		...
		ofstream fileTempo;
		string fileName2;
		fileName2 = "RRSVD_Timing_"+to_string(ii)+".dat";
...
//
		...
		fileName= "RRdecU"+to_string(ii)+".dat";
